...
public class AddToDoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				datePickerButton.setText(R.string.no_date_set_string);
				timePickerButton.setText(R.string.no_time_set_string);
				// dateView.setText(R.string.no_date_set_string);

				// timeView.setText(R.string.no_time_set_string);
			}
		});
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				titleString = getToDoTitle();

				// Construct the Date string
				String fullDate = dateString + " " + timeString;

				// work here
				// fullDate =dateView.getText().toString() + " " +
				// timeView.getText().toString();
				fullDate = datePickerButton.getText().toString() + " "
	...
	private void setDefaultDateTime() {
		...
		timePickerButton.setText(dateString);
